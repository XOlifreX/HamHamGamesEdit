...
void QtView::openFile() {
	...
	if (!this->sv->isValidSave()) {
		this->showWarningDialog("This file is not a valid Hamtaro Ham Ham Games .sav file.\n Make sure the file is an original .sav file generated by the game itself.");
		return;
	}
